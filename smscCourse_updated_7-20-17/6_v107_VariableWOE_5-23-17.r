...
#OUTPUT: Dataframe and scatter plots for WOE at each: transition, county, variable, bin
...
setwd("V:/IaraSpatialLayers/SPProfessionalTrainingCourse/ScenarioPlanningCourse/Dinamica_Runs/SMSC_107/smsc_1071/BasicDataAnalyses")
...
S20_GEOID <-  read.csv("V:/IaraSpatialLayers/SPProfessionalTrainingCourse/Dinamica_Runs/SMSC_107/smsc_1071/SMSCcntyOnly.csv")
v107WOE <- read.csv("V:/IaraSpatialLayers/SPProfessionalTrainingCourse/Dinamica_Runs/SMSC_107/smsc_1071/BasicDataAnalyses/sav107allWOE_sa.csv") # This is the compiled tables.#####################################
...
smsc_ctyGEOIDzero<-smsc_ctyGEOID
smsc_ctyGEOIDzero$Din_cty<-sapply(smsc_ctyGEOIDzero$Din_cty, function(x){if(nchar(x)<2){paste0(0,x)}else{x}}) 
...
# --------------------------------------------------------
# --------------------------------------------------------
# Setting up counties raster and input files 
# --------------------------------------------------------
# --------------------------------------------------------
...
S20_GEOID <-  read.csv("V:/IaraSpatialLayers/SPProfessionalTrainingCourse/Dinamica_Runs/SMSC_107/smsc_1071/SMSCcntyOnly.csv")
 	# VALUE	GEOID	NAME
# 1	3	51079	Frederick County
# 2	4	51107	Loudoun County
# 3	6	51171	Shenandoah County
