...
#Modifier_Q1 <- read.csv("V:/IaraSpatialLayers/Dinamica_Runs/StudyArea_V201/SA_V2013/Parameters/Transition_Rates/modifiers/flat.csv")
#new_rates <- modify.rate(Modifier_Q1$Transition_Number, regioncols, Modifier_Q1,sa_cty_transitions_lum)

#Modifier_Q2 <- read.csv("V:/IaraSpatialLayers/Dinamica_Runs/StudyArea_V201/SA_V2013/Parameters/Transition_Rates/modifiers/Rate_Modifier_Stakeholder_Q2.csv")
#new_rates <- modify.rate(Modifier_Q2$Transition_Number, regioncols, Modifier_Q2,sa_cty_transitions_lum)

Modifier_Q3 <- read.csv("V:/IaraSpatialLayers/Dinamica_Runs/StudyArea_V201/SA_V2013/Parameters/Transition_Rates/modifiers/Rate_Modifier_Stakeholder_Q3.csv")
new_rates <- modify.rate(Modifier_Q3$Transition_Number, regioncols, Modifier_Q3,sa_cty_transitions_lum)

#Modifier_Q4 <-read.csv("V:/IaraSpatialLayers/Dinamica_Runs/StudyArea_V201/SA_V2013/Parameters/Transition_Rates/modifiers/flat.csv")
...
# Q1:
#write.csv(FINAL, file="V:/IaraSpatialLayers/Dinamica_Runs/StudyArea_V201/SA_V2011/Parameters/Transition_Rates/sa_Trans_Rates_FGC-DFGC_flat.csv",row.names=FALSE, quote=FALSE)

# Q2:
#write.csv(FINAL, file="V:/IaraSpatialLayers/Dinamica_Runs/StudyArea_V201/SA_V2011/Parameters/Transition_Rates/sa_Trans_Rates_FGC-DFGC_Q2_stakeholder.csv",row.names=FALSE, quote=FALSE)

# Q3:
write.csv(FINAL, file="V:/IaraSpatialLayers/Dinamica_Runs/StudyArea_V201/SA_V2011/Parameters/Transition_Rates/sa_Trans_Rates_FGC-DFGC_Q3_stakeholder.csv",row.names=FALSE, quote=FALSE)

# Q4:
#write.csv(FINAL, file="V:/IaraSpatialLayers/Dinamica_Runs/StudyArea_V201/SA_V2011/Parameters/Transition_Rates/sa_Trans_Rates_FGC-DFGC_Q4_stakeholder.csv",row.names=FALSE, quote=FALSE)
