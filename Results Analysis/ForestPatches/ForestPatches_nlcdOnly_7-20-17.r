...
RasterLoc <- "V:/IaraSpatialLayers/Dinamica_Runs/StudyArea_V108/SA_V1081/FutureLandscapes/"

Output_Folder <- "V:/IaraSpatialLayers/Dinamica_Runs/StudyArea_V108/SA_V1081/Patch_Stats/"
# ----------------------------------------------
# READ OUTPUT FILES:
...
# ----------------------------------------------
# NLCD 2001 & 2011:
nl01 <- raster("V:/IaraSpatialLayers/Dinamica_Runs/StudyArea_V108/SA_V1081/FutureLandscapes/NL/nlcd_nlcd/nlcd01_anC.img")
nl11 <- raster("V:/IaraSpatialLayers/Dinamica_Runs/StudyArea_V108/SA_V1081/FutureLandscapes/NL/nlcd_nlcd/nlcd11_anC.img")
...
# County Tables:
S20_GEOID<- read.table("V:/IaraSpatialLayers/Dinamica_Runs/StudyArea_V108/SAcntyOnly.csv", header = T, sep=",")
